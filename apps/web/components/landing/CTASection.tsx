...
export function CTASection() {
  return (
    <section className="max-w-5xl mx-auto px-margin py-12 sm:py-xl mb-[60px] sm:mb-[100px] relative">
      ...
      <div className="bg-surface-container-lowest border border-outline-variant/35 rounded-[32px] overflow-hidden shadow-[0_20px_50px_rgba(70,72,212,0.06)] relative">
        ...
        <div className="p-8 sm:p-[64px] text-center relative z-10 flex flex-col items-center">
          <span className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 text-primary text-[11px] font-bold uppercase tracking-wider px-3.5 py-1.5 rounded-full mb-sm">
            <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
            Instant Deployment
          </span>

          <h2 className="text-[32px] sm:text-[52px] font-bold text-on-surface mb-md tracking-tight leading-[1.15] max-w-3xl text-center text-balance">
            Ready for{" "}
          ...
          <p className="text-body-md sm:text-body-lg text-on-surface-variant max-w-2xl mx-auto mb-xl leading-[1.6]">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-md w-full sm:w-auto">
            <Link
              href="/dashboard"
              className="group relative w-full sm:w-auto text-label-md font-label-md bg-gradient-to-r from-primary to-primary-container text-on-primary px-xl py-4 rounded-xl shadow-[0_8px_24px_rgba(70,72,212,0.25)] hover:shadow-[0_12px_32px_rgba(70,72,212,0.35)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 inline-block text-center overflow-hidden"
            >
            ...
            <Link
              href="/templates"
              className="w-full sm:w-auto text-label-md font-medium text-on-surface-variant border border-outline-variant/40 hover:border-primary/40 hover:text-primary px-xl py-4 rounded-xl transition-all duration-200 inline-block text-center hover:-translate-y-0.5 bg-surface-container/40 hover:bg-surface-container"
            >
              Explore Themes
            </Link>
          </div>

          <p className="text-label-sm text-on-surface-variant flex items-center gap-1.5 mt-md">
