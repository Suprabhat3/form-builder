            ...
            <div className="w-full max-w-70 mt-ds-xs">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="flex gap-ds-xs">
                <input
                  ...
                  className="grow h-9 px-3 rounded-lg border border-outline-variant/35 bg-surface-container/30 dark:bg-surface-container-high/10 text-xs text-on-surface placeholder:text-on-surface-variant/50 focus:outline-none focus:border-primary/50 transition-all"
                />
                <button
                  type="submit"
                  className="h-9 px-3 rounded-lg bg-primary text-on-primary text-xs font-bold shadow hover:opacity-95 transition-all shrink-0"
                >
                  Join
                </button>
              </form>
