...
export function AuthForm({ type }: { type: "login" | "signup" }) {
  ...
  return (
    <div className="bg-background text-on-surface font-body-md antialiased min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-grow flex items-center justify-center relative z-10 w-full" style={{ padding: '64px 32px' }}>
        <div className="w-full bg-surface-container-lowest rounded-2xl border border-outline-variant/40 soft-focus-shadow hover-lift relative overflow-hidden group" style={{ maxWidth: '448px', padding: '40px' }}>
          {/* Decorative subtle top gradient */}
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-primary to-transparent opacity-50"></div>
          
          <div className="absolute top-[-50px] right-[-50px] bg-primary-fixed/20 rounded-bl-full -z-10 transition-transform group-hover:scale-110 duration-500" style={{ width: '128px', height: '128px' }}></div>
          ...
          <form className="flex flex-col" style={{ gap: '24px' }}>
            ...
            <div className="flex flex-col" style={{ gap: '8px' }}>
              <div className="flex justify-between items-center">
                ...
                {isLogin && (
                  <Link href="#" className="font-medium text-primary hover:underline" style={{ fontSize: '14px' }}>
                    Forgot password?
                  </Link>
                )}
              </div>
          ...
          <div className="flex items-center" style={{ gap: '16px', margin: '32px 0' }}>
            ...
            <span className="font-medium text-on-surface-variant uppercase tracking-wider" style={{ fontSize: '12px' }}>
              Or continue with
            </span>
            <div className="h-px bg-outline-variant/40 flex-1"></div>
          </div>

          <button className="w-full font-bold bg-surface-container-lowest border border-outline-variant/50 text-on-surface rounded-lg hover:border-primary hover:text-primary transition-all duration-200 flex items-center justify-center soft-focus-shadow" style={{ padding: '14px 40px', gap: '12px', fontSize: '14px' }}>
          ...
          <p className="text-center text-on-surface-variant" style={{ fontSize: '16px', marginTop: '32px' }}>
